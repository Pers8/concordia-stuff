          ...
          {showGraph && items.length > 0 && (
            <div style={{ 
              ...
              <div style={{ 
                ...
                borderRadius:12, 
                padding:12,
                border:'1px solid rgba(52,86,123,0.2)',
              }}>
                <div style={{ display:'flex', gap:2, height:48, alignItems:'flex-end', position:'relative' }}>
                  {last30.map((d, i) => {
                    ...
                    return (
                      <div
                        key={i}
                        title={`${new Date(d.date).toLocaleDateString('en-US', {month:'short',day:'numeric'})}: ${d.count} commit${d.count !== 1 ? 's' : ''}`}
                        style={{
                          flex: 1,
                          height: `${pct}%`,
                          ...
                          background: d.count > 0 
                            ? `linear-gradient(to top, 
                                ${intensity > 0.7 ? '#7aa2f7' : intensity > 0.4 ? '#5a82d7' : '#4a6fc7'}, 
                                ${intensity > 0.7 ? '#5a82d7' : intensity > 0.4 ? '#4a6fc7' : '#3a5fb7'})` 
                            : 'rgba(52,86,123,0.15)',
                          borderRadius: '4px 4px 0 0',
                          transition: 'all 300ms cubic-bezier(0.2, 0.8, 0.2, 1)',
                          cursor: 'pointer',
                          position: 'relative',
                          boxShadow: d.count > 0 ? `0 0 ${8 + intensity * 12}px rgba(122,162,247,${0.3 + intensity * 0.3})` : 'none',
                          animation: `barGrow 500ms ease-out ${i * 15}ms both`,
                        }}
                        onMouseEnter={e => { 
                          if (d.count > 0) {
                            e.currentTarget.style.transform = 'scaleY(1.08) translateY(-2px)'
                            e.currentTarget.style.boxShadow = `0 0 ${16 + intensity * 20}px rgba(122,162,247,${0.5 + intensity * 0.4})`
                          }
                        }}
                        onMouseLeave={e => { 
                          e.currentTarget.style.transform = 'scaleY(1) translateY(0)'
                          e.currentTarget.style.boxShadow = d.count > 0 ? `0 0 ${8 + intensity * 12}px rgba(122,162,247,${0.3 + intensity * 0.3})` : 'none'
                        }}
                      />
                    )
                  })}
                </div>
                <div style={{ display:'flex', justifyContent:'space-between', marginTop:8, fontSize:9, color:'#6B8099', fontWeight:600 }}>
  ...
  return (
    <>
        ...
        <aside className="border rounded-xl m-3 mr-2 p-3 flex flex-col h-[calc(100%-2.5rem)] min-h-0" style={{
          ...
          {bulkMode && (
            <div style={{
              marginBottom: 12,
              padding: 16,
              background: 'linear-gradient(135deg, rgba(122,162,247,0.08), rgba(16,28,48,0.6))',
              border: '1.5px solid rgba(122,162,247,0.3)',
              borderRadius: 16,
              backdropFilter: 'blur(16px)',
              WebkitBackdropFilter: 'blur(16px)',
              boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.08), 0 4px 16px rgba(122,162,247,0.15)',
              animation: 'slideDownFade 300ms cubic-bezier(0.2, 0.8, 0.2, 1)',
            }}>
              <div style={{ 
                fontSize: 11, 
                color: '#7aa2f7', 
                ...
                <div style={{ 
                  width: 20, height: 20, 
                  borderRadius: 8,
                  background: 'linear-gradient(135deg, rgba(122,162,247,0.3), rgba(122,162,247,0.15))',
                ...
                <span>{selectedVaults.size === 0 ? 'SELECT VAULTS' : `${selectedVaults.size} SELECTED`}</span>
              </div>
              <div style={{ display: 'flex', gap: 8, marginBottom: 8 }}>
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 10,
                    padding: '8px 12px',
                    color: selectedVaults.size === filteredVaults.length ? '#6B8099' : '#9DB8D9',
                    fontSize: 11,
                    cursor: selectedVaults.size === filteredVaults.length ? 'not-allowed' : 'pointer',
                    transition: 'all 200ms cubic-bezier(0.2, 0.8, 0.2, 1)',
                    fontWeight: 700,
                    letterSpacing: '0.02em',
                  }}
                  onMouseEnter={e => {
                    if (selectedVaults.size !== filteredVaults.length) {
                      e.currentTarget.style.background = 'linear-gradient(135deg, rgba(122,162,247,0.15), rgba(122,162,247,0.08))'
                      e.currentTarget.style.borderColor = 'rgba(122,162,247,0.5)'
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 10,
                    padding: '8px 12px',
                    color: selectedVaults.size === 0 ? '#6B8099' : '#9DB8D9',
                    fontSize: 11,
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                <button
                  ...
                  style={{
                    flex: 1,
                    background: selectedVaults.size === 0 
                      ? 'rgba(16,28,48,0.5)'
                      : 'linear-gradient(135deg, rgba(52,211,153,0.2), rgba(52,211,153,0.1))',
                    border: '1.5px solid',
                    borderColor: selectedVaults.size === 0 ? 'rgba(52,86,123,0.3)' : 'rgba(52,211,153,0.4)',
                    borderRadius: 10,
                    padding: '9px 14px',
                    color: selectedVaults.size === 0 ? '#6B8099' : '#34d399',
                    fontSize: 11,
                    cursor: selectedVaults.size === 0 ? 'not-allowed' : 'pointer',
                    transition: 'all 220ms cubic-bezier(0.2, 0.8, 0.2, 1)',
                    fontWeight: 700,
      ...
      `}</style>
                  ...
                  onMouseEnter={e => {
                    if (selectedVaults.size !== 0) {
                      e.currentTarget.style.background = 'linear-gradient(135deg, rgba(52,211,153,0.28), rgba(52,211,153,0.15))'
                      e.currentTarget.style.transform = 'translateY(-2px)'
                      e.currentTarget.style.boxShadow = 'inset 0 1px 0 rgba(255,255,255,0.1), 0 4px 12px rgba(52,211,153,0.25)'
                    }
                  }}
                  onMouseLeave={e => {
                    if (selectedVaults.size !== 0) {
                ...
                <button
                  ...
                  style={{
                    ...
                    border: '1.5px solid',
                    borderColor: selectedVaults.size === 0 ? 'rgba(52,86,123,0.3)' : 'rgba(255,107,107,0.4)',
                    borderRadius: 10,
                    padding: '9px 14px',
